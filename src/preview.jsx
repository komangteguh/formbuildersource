...
export default class Preview extends React.Component {
  ...
  componentDidUpdate(nextProps) {
    ...
    if (this.props.imageUpdated !== nextProps.imageUpdated) {
      this.updateElement(nextProps.imageUpdated);
    }
  }
  componentDidMount() {
  ...
  updateElement(element) {
    ...
    for (let i = 0, len = data.length; i < len; i++) {
      if (element && data[i] && element.id === data[i].id) {
        data[i] = element;
        found = true;
        break;
      }
  ...
  onMoveUp(item) {
    ...
    if (currentIndex != 0) {
      ...
      this.moveCard(currentIndex, moveToIndex);
    }
  }
        ...
        <div className="edit-form" ref={this.editForm}>
          {this.props.editElement !== null && (
            <FormElementsEdit
              ...
              // cancelEditModeOff={this.cancelEditModeOff}
              preview={this}
